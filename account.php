    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li <?php if(@$_GET['q']==2) echo'class="active"'; ?>><a href="account.php?q=2"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span>&nbsp;History</a></li>
    		...
    		<li <?php if(@$_GET['q']==4) echo'class="active"'; ?>> <a href="logout.php?q=account.php"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Signout</a></li> 
		  </ul>
      <ul>
         <li><div class="col-md-3 box col-md-offset-2">
             <?php
             include_once 'dbConnection.php';
            session_start();
            ...
            include_once 'dbConnection.php';
            echo '<span class="top"><span class="log1"><span class="glyphicon glyphicon-user" aria-hidden="true"><a href="#" data-toggle="modal" data-target="#userprofile">'."Hello,&nbsp;".$name.'</a></span></span></span>';
            }?>
          </div></li>
      </ul>        
    </div><!-- /.navbar-collapse -->
...
<tr><td><b>Sl. No.</b></td><td><b>Course Name</b></td><td><b>Total question(s)</b></td><td><b>Marks</b></td><td><b>Time Duration</b></td><td></td></tr>';
$c=1;
...
echo  '<div class="panel title" style="text-align:center;">
<table class="table table-striped title1" >
<tr style="color:red"><td><b>Sl. No.</b></td><td><b>Quiz</b></td><td><b>Question Solved</b></td><td><b>Right</b></td><td><b>Wrong<b></td><td><b>Score</b></td>';
$c=0;
while($row=mysqli_fetch_array($q) )
{
$eid=$row['eid'];
